...
const Servmeubcard = ({sell}) => {
  return (
    <div className='px-16 flex gap-5 mt-5 '>
        <div className='flex flex-col pb-5  bg-white shadow-lg w-60 '>
            <div className='w-60 mb-3'><motion.img whileHover={{scale:0.9}} src={sell.imgUrl} alt="" /> </div>
            <h5 className='px-5 font-bold'>{sell.productName}</h5>
            <span className='px-5'>{sell.category}</span>
