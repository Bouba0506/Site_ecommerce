...
const Header = () => {
    ...
    return (
        <div className='mt-2 w-full bg-white shadow-2xl cursor-pointer  relative'>
            <div className=' flex items-center w-full bg-white gap-5 h-16 md:gap-12 px-8 md:px-20 fixed top-0 right-0 left-0 '>
                ...
                <div className='flex items-center w-full ml-0 lg:ml-36 justify-between'>
                    <ul className='hidden md:flex  gap-5  items-center'>
                        <li className='text-2xl font-medium hover:text-gray-400 hover:-translate-y-1 duration-500'><Link to="home"> Home</Link></li>
                    ...
                    <div className='flex items-center relative gap-4'>
                        ...
                        <span><i class="ri-shopping-bag-fill"></i><span  className='absolute top-0 text-white rounded-full h-[15px] w-[15px] text-[0.7rem] flex items-center justify-center bg-red-800'>2</span></span>
