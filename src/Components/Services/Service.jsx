...
export const Service = () => {
  return (
    <div>
       <div className='mt-4 grid grid-cols-1 md:flex gap-5 px-12 md:px-5 items-center justify-center'>
        {serviceData.map((servic,index)=>(
             <motion.div whileHover={{scale:1.1}} className='flex items-center gap-2  w-60 rounded-md px-3' key={index} style={{background: `${servic.bg}`}}>
